...
import ThankYou from "../../Pages/IAMRoleWizard/ThankYou"; // already imported
...
const Step3 = ({ data, onBack }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      toast.error(error.response?.data?.message || "Submission failed. Please try again!"); // <<=== Show toast error
    }
  };
